  ...
  <div class="flex w-full">
    <div class="flex flex-col justify-between border-e border-neutral-100 dark:border-neutral-800 w-1/6 ">
      ...
      <div class="menu-wrapper">
        <ul class="space-y-1">
          <li>
            <a href="#" class="flex items-center gap-2 bg-blue-800/10 px-4 py-3 text-sm font-medium text-blue-500">
          ...
          <li>
            <a href="#" class="flex items-center gap-2 px-4 py-3 text-sm font-medium text-neutral-500 hover:bg-neutral-100 hover:text-neutral-700 dark:hover:bg-neutral-900 dark:hover:text-neutral-300">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
