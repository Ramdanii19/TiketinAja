...
<body class="bg-gray-100 text-gray-800 min-h-screen overflow-hidden">
    <div class="min-h-screen flex justify-center items-start p-8"> <!-- Mengubah justify-center menjadi justify-start dan items-start untuk posisi atas -->
  ...
  <div class="max-w-screen-xl mx-auto px-4 text-center">
    <h5 class="text-lg font-medium mb-2">
      <a href="dashboard.php" class="text-white hover:text-indigo-600 font-medium">
        Back to home menu
      </a>
    </h5>
  </div>
