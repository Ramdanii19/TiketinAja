        ...
        <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    <a href="#" class="rounded-md bg-indigo-600 px-5 py-2.5 text-sm font-medium text-white shadow">Login</a>
                    <a href="#" class="rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-indigo-600">Register</a>
                </div>
            </div>
        </div>
    </header>
            ...
            <form class="space-y-4" action="penerbanganTersedia.php" method="post">
                ...
                <fieldset class="grid grid-cols-2 sm:flex gap-4">
                    <label class="flex justify-start items-center gap-4 bg-white rounded-lg px-5 py-3 text-sm">
                        <input type="radio" name="tipe" value="pp" id="pp" <?php if ($_SESSION['tipe'] == 'pp') echo 'checked'; ?>>
                        <span class="cursor-pointer">Pulang-Pergi</span>
                    </label>
                    <label class="flex justify-start items-center gap-4 bg-white rounded-lg px-5 py-3 text-sm">
                        <input type="radio" name="tipe" value="sekali" id="sekali" <?php if ($_SESSION['tipe'] == 'sekali') echo 'checked'; ?>>
                ...
                <div class="grid grid-cols-1 lg:flex lg:items-center gap-4">
                    ...
                    <input type="date" name="keberangkatan" value="<?php echo $_SESSION['keberangkatan'] ?>" class="p-4 rounded-lg w-full border-gray-300" placeholder="Tanggal Berangkat">
                    ...
                    <input type="number" name="jumlah" value="<?php echo $_SESSION['jumlahPenumpang'] ?>" placeholder="Jumlah Penumpang" class="p-4 rounded-lg bg-white text-sm w-full border-gray-300">
                </div>
